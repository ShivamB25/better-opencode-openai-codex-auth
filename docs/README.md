...
**Testing**: 247 unit tests + integration tests

---

**Quick Links**: [GitHub](https://github.com/ShivamB25/better-opencode-openai-codex-auth) • [npm](https://www.npmjs.com/package/better-opencode-openai-codex-auth) • [Issues](https://github.com/ShivamB25/better-opencode-openai-codex-auth/issues)
