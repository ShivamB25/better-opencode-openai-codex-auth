...
### Added
- **One-command installer/update**: `bunx better-opencode-openai-codex-auth@latest` (global config, backup, cache clear) with `--legacy` for OpenCode v1.0.209 and below.
